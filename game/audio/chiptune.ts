...
const TRACKS: Track[] = [
  {
    ...
    lead: [
      [0, 1], [4, 1], [7, 1], [4, 1],
      [9, 1.5], [7, 0.5], [4, 1], [null, 1],
      [0, 1], [4, 1], [7, 1], [12, 1],
      [9, 1.5], [7, 0.5], [4, 1], [null, 1],
      [5, 1], [9, 1], [12, 1], [9, 1],
      [7, 1.5], [4, 0.5], [0, 1], [null, 1],
      [5, 1], [4, 1], [2, 1], [4, 1],
      [0, 2], [null, 2],
    ],
    bass: [
  ...
  },
  {
    ...
    bassType: "sawtooth",
    lead: [
      [-3, 0.5], [0, 0.5], [2, 0.5], [4, 0.5], [5, 1], [4, 0.5], [2, 0.5],
      [0, 1], [-1, 1], [-3, 2],
      [-3, 0.5], [0, 0.5], [2, 0.5], [4, 0.5], [7, 1], [5, 0.5], [4, 0.5],
      [2, 1], [4, 1], [5, 2],
      [4, 0.5], [5, 0.5], [7, 0.5], [9, 0.5], [7, 1], [5, 0.5], [4, 0.5],
      [2, 1], [0, 1], [-1, 2],
      [0, 0.5], [-1, 0.5], [-3, 1], [null, 0.5], [-3, 0.5], [-1, 0.5], [0, 0.5],
      [-3, 2], [null, 2],
    ],
    bass: [
      [-27, 1], [-27, 1], [-20, 1], [-27, 1],
  ...
  { kind: "file", name: "TIDE POOLS", url: "/assets/audio/tide-pools-at-twilight.mp3" },
  { kind: "file", name: "SUNSET OFFBEAT", url: "/assets/audio/sunset-offbeat.mp3" },
  {
    kind: "file",
    name: "GOLDEN AFTERNOON",
    url: "/assets/audio/golden-afternoon-groove.mp3",
  },
  { kind: "file", name: "BURNT SUNSET", url: "/assets/audio/burnt-sunset-groove.mp3" },
  {
    kind: "file",
    name: "BLUE BELOW",
  ...
  },
  {
    ...
    bassType: "triangle",
    lead: [
      [0, 0.5], [0, 0.5], [7, 0.5], [7, 0.5], [9, 0.5], [9, 0.5], [7, 1],
      [5, 0.5], [5, 0.5], [4, 0.5], [4, 0.5], [2, 0.5], [2, 0.5], [0, 1],
      [7, 0.5], [7, 0.5], [5, 0.5], [5, 0.5], [4, 0.5], [4, 0.5], [2, 1],
      [0, 0.5], [0, 0.5], [7, 0.5], [7, 0.5], [9, 0.5], [9, 0.5], [7, 1],
      [5, 0.5], [5, 0.5], [4, 0.5], [4, 0.5], [2, 0.5], [2, 0.5], [0, 1],
      [null, 1], [4, 0.5], [7, 0.5], [12, 1], [null, 1],
    ],
    bass: [
      [-24, 1], [-12, 1], [-24, 1], [-12, 1],
      [-17, 1], [-5, 1], [-17, 1], [-5, 1],
...
function scheduleVoice(
  ...
  const scheduleLoop = () => {
    ...
    timer = setTimeout(scheduleLoop, (nextLoopStart - audio.currentTime - 0.5) * 1000);
  };
  scheduleLoop();
  return () => {
...
async function startCurrent(): Promise<void> {
  ...
  voiceStops.push(
    scheduleVoice(ctx, master!, track.lead, track.leadType, 0.05, track.bpm, mySession),
    scheduleVoice(ctx, master!, track.bass, track.bassType, 0.08, track.bpm, mySession),
...
export function setTrack(index: number) {
  trackIndex = ((Math.round(index) % TRACKS.length) + TRACKS.length) % TRACKS.length;
}
